...
#define _SSID "risagami2G"        // Your WiFi SSID
#define _PASSWORD "cesabe01"    // Your WiFi Password
#define PROJECT_ID "appmibismarthome-default-rtdb.firebaseio.com"   // Your Firebase Project ID. Can be found in project settings.
